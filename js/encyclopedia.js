...
const STATIC_FISH = [
    ...
    { title: "Kefal", emoji: "🐟", image: "img/kefal.jpg", region: "Xəzər dənizi sahilləri", bait: "Duz xəmiri, çörək", season: "İyun - Oktyabr", text: "Dəniz sahillərində sürü halında üzən sürətli balıqdır. Sakit hava şəraitində sahilə yaxınlaşır.", rod: "Dəniz serf çubuğu, 3.6-4.2 m", tackle: "Yüngül dəniz donka/poplavok montajı", lure: "Çörək, krevet, dəniz qurdu (nereis)", chum: "Torpaqla qarışdırılmış çörək qırıntısı (yavaş dib batır)" },
    { title: "Çapaq (Лещ)", emoji: "🐡", image: "img/chapaq.jpg", region: "Kür, su anbarları", bait: "Qarğıdalı, qurd, xəmir", season: "Aprel - Oktyabr", text: "Dərin və sakit sularda yaşayan, gecə və dan vaxtı fəallaşan klassik göl balığıdır.", rod: "Fider çubuğu, 3.6-3.9 m, test 40-80 q", tackle: "Klassik fider montajı və ya \"tük\" montaj", lure: "Qurd+opariş \"sendviç\", perlovka", chum: "Tünd fider yemi (kakao/jom əlavəli)" },
    { title: "Nərə (Ştrelin)", emoji: "🦈", image: "img/nere.jpg", region: "Xəzər dənizi", bait: "Qorunur / ovu qadağandır", season: "—", text: "Xəzərin əfsanəvi nəhəng balığıdır. Populyasiyası kəskin azaldığı üçün ovu qanunla qadağandır və ya ciddi şəkildə tənzimlənir — yalnız məlumat üçün.", rod: "—", tackle: "—", lure: "—", chum: "—" },
    { title: "Som", emoji: "🐋", image: "img/som.jpg", region: "Kür çayı, dərin su anbarları", bait: "Canlı balıqcıq, qurbağa təqlidi", season: "May - Sentyabr (isti gecələr)", text: "Çayın ən iri yırtıcılarından biridir. Adətən gecə vaxtı, dərin çuxurlarda ovlanır, güclü ləvazimat tələb edir.", rod: "Güclü som çubuğu (kastinq), test 100-300 q", tackle: "Kvok + donka montajı, və ya iri cig-silikon", lure: "Canlı balıqcıq, qurbağa, toyuq qaraciyəri, midiya əti", chum: "Adətən tələb olunmur — kvok səsi balığı cəlb edir" },
    { title: "Xramulya", emoji: "🐠", region: "Quba, Qusar dağ çayları", bait: "Yosun, xırda həşərat", season: "Aprel - Oktyabr", text: "Dağ çaylarının sürətli axarlarında yaşayan, daş üzərindəki yosunlarla qidalanan balıqdır.", rod: "Yüngül spinning və ya maxovoy çubuğu", tackle: "Axar suda yüngül poplavok montajı", lure: "Yosun tikəsi, opariş, xırda həşərat", chum: "Adətən tələb olunmur" }
];
...
function renderFishCard(data, index) {
    ...
    const gearRows = [];
    if (data.rod) gearRows.push(`<div class="fish-gear-row"><span class="fish-gear-ico">🎣</span><span><b>Balıq çubuğu:</b> ${data.rod}</span></div>`);
    if (data.tackle) gearRows.push(`<div class="fish-gear-row"><span class="fish-gear-ico">🧵</span><span><b>Montaj:</b> ${data.tackle}</span></div>`);
