...
const STATIC_FISH = [
    ...
    { title: "Ağ amur", emoji: "🐟", region: "Kür çayı, su anbarları", bait: "Yaşıl otlar, qarğıdalı", season: "İyun - Sentyabr", text: "Bitki mənşəli yem sevən iri balıqdır. İsti aylarda səthə yaxın, sudakı bitkilərin yanında axtarılmalıdır." },
    { title: "Qayabalığı (Qalınalın)", emoji: "🐠", region: "Dağ çayları (Quba, Qəbələ)", bait: "Qurd, həşərat təqlidi", season: "Aprel - Oktyabr", text: "Sürətli axarlı, daşlı dib olan dağ çaylarını sevir. Günorta saatlarında daha aktiv olur." },
    { title: "Forel (Alabalığı)", emoji: "🎣", region: "Dağ çayları, soyuq bulaqlar", bait: "Süni milçək, qurd", season: "Sentyabr - May (soyuq aylar)", text: "Soyuq və təmiz suları sevən qiymətli balıqdır. İsti yay aylarında aktivliyi kəskin azalır." },
    { title: "Külmə / Vobla", emoji: "🐟", region: "Xəzər sahili, Kür mənsəbi", bait: "Qurd, çörək xəmiri", season: "Mart - May", bait2: "", text: "Kiçik, lakin çox sayda tutulan sahil balığıdır. Sürü halında hərəkət etdiyi üçün bir yerdə uzun müddət clev verə bilər." },
    { title: "Şəmayı", emoji: "🐠", region: "Kür çayı, su anbarları", bait: "Xırda qurd, milçək", season: "May - Avqust", text: "Parlaq gümüşü rəngli, sürətli üzən kiçik balıqdır. Səthə yaxın suda, gün doğuşunda daha fəaldır." },
    { title: "Şirbit (Usaç)", emoji: "🐡", region: "Kür və Araz çayları", bait: "Qurd, xərçəngkimilər", season: "May - Sentyabr", text: "Axar suların dibində, daşların arasında yaşayan güclü balıqdır. Axşam saatlarında ovu daha uğurlu olur." },
    { title: "Kefal", emoji: "🐟", region: "Xəzər dənizi sahilləri", bait: "Duz xəmiri, çörək", season: "İyun - Oktyabr", text: "Dəniz sahillərində sürü halında üzən sürətli balıqdır. Sakit hava şəraitində sahilə yaxınlaşır." },
    { title: "Çapaq (Лещ)", emoji: "🐡", region: "Kür, su anbarları", bait: "Qarğıdalı, qurd, xəmir", season: "Aprel - Oktyabr", text: "Dərin və sakit sularda yaşayan, gecə və dan vaxtı fəallaşan klassik göl balığıdır." },
    { title: "Nərə (Ştrelin)", emoji: "🦈", region: "Xəzər dənizi", bait: "Qorunur / ovu qadağandır", season: "—", text: "Xəzərin əfsanəvi nəhəng balığıdır. Populyasiyası kəskin azaldığı üçün ovu qanunla qadağandır və ya ciddi şəkildə tənzimlənir — yalnız məlumat üçün." },
    { title: "Som", emoji: "🐋", region: "Kür çayı, dərin su anbarları", bait: "Canlı balıqcıq, qurbağa təqlidi", season: "May - Sentyabr (isti gecələr)", text: "Çayın ən iri yırtıcılarından biridir. Adətən gecə vaxtı, dərin çuxurlarda ovlanır, güclü ləvazimat tələb edir." },
